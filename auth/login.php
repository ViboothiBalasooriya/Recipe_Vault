    ...
    <div class="row g-0 split-layout">
        ...
        <div class="col-lg-5 col-xl-4 form-section mx-auto">
            <div class="w-100" style="max-width: 420px; margin: 0 auto;">
                ...
                <p class="text-muted mb-4 pb-2" style="font-size: 0.95rem;">Sign in to your account to continue your culinary journey.</p>
                
                <?php if ($success): ?>
                    <div class="alert alert-success border-0 small fw-bold"><i class="fas fa-check-circle me-2"></i><?php echo $success; ?></div>
                <?php endif; ?>
                <?php if ($error): ?>
                ...
                <div class="auth-toggle">
                    <a href="login.php" class="btn active w-50">Login</a>
                    <a href="register.php" class="btn inactive w-50">Sign Up</a>
                </div>
                ...
                <form method="POST" id="loginForm" novalidate>
                    ...
                    <button class="btn btn-success w-100 py-3 fw-bold mb-4" type="submit">Sign In</button>
                    
                    <p class="text-center small text-muted mb-0">Don't have an account? <a class="text-success fw-bold text-decoration-none" href="register.php" style="color: #20c997 !important;">Join the community</a></p>
                </form>
            </div>
        </div>
